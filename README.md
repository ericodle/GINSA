...
GINSA downloads SSU rDNA sequences from each occurrence, combining them into a single FASTA file.<br /><br />
 ...
 GINSA has been tested on <i>Lecudina longissima</i> (26 occurrences), <i>Tetraselmis marina</i> (188 occurrences), <i>Lecudina tuzetae</i> (309 occurrences), and <i>Labyrinthula spp.</i> (2,603 occurrences).
